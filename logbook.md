...
| 25.2026 | 7,5 | Performing an authorization test |Found pages and endpoints using different tools and tested POSTS. Created a zap report and own findings report |
